...
```
~/.claude/skills/create-skill/workflows/CanonicalizeSkill.md
```
...
skills/utilities/prompting/be-creative.md                  # Templates in Prompting root
skills/utilities/prompting/StoryExplanation.md            # Templates in Prompting root
skills/prompt-injection/DefenseMechanisms.md     # Context file - in root
skills/prompt-injection/QuickStartGuide.md       # Context file - in root
```
...
- Correct: `skills/utilities/prompting/be-creative.md`
