...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Running the ResearchUpgrade workflow in the pai-upgrade skill to research upgrades"}' \
  > /dev/null 2>&1 &
```

Running the **ResearchUpgrade** workflow in the **pai-upgrade** skill to research upgrades...
