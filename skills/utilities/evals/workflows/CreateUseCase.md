...
```bash
mkdir -p ~/.claude/skills/utilities/evals/use-cases/<name>/{test-cases,golden-outputs,prompts}
```

### Step 3: Create Config File

Create `~/.claude/skills/utilities/evals/use-cases/<name>/config.yaml`:
...
Create `~/.claude/skills/utilities/evals/use-cases/<name>/prompts/v1.0.0.md`:
...
Create test cases in `~/.claude/skills/utilities/evals/use-cases/<name>/test-cases/`:
...
Create `~/.claude/skills/utilities/evals/use-cases/<name>/README.md`:
...
```bash
# Check structure
ls -la ~/.claude/skills/utilities/evals/use-cases/<name>/
