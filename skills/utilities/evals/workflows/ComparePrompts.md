...
```bash
# Check prompts exist
ls ~/.claude/skills/utilities/evals/use-cases/<name>/prompts/
...
Create `~/.claude/skills/utilities/evals/use-cases/<name>/comparisons/<comparison-name>.yaml`:
...
bun run ~/.claude/templates/tools/RenderTemplate.ts \
  ...
  -d ~/.claude/skills/utilities/evals/use-cases/<name>/comparisons/<name>.yaml \
  -o ~/.claude/skills/utilities/evals/use-cases/<name>/comparisons/<name>-setup.md \
  --preview
```
