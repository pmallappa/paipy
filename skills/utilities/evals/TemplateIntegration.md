...
bun run ~/.claude/templates/tools/RenderTemplate.ts \
  -t Evals/Judge.hbs \
  -d ~/.claude/skills/utilities/evals/use-cases/<name>/judge-config.yaml \
  -o ~/.claude/skills/utilities/evals/use-cases/<name>/judge-prompt.md
```
...
bun run ~/.claude/templates/tools/RenderTemplate.ts \
  -t Evals/Rubric.hbs \
  -d ~/.claude/skills/utilities/evals/use-cases/<name>/rubric.yaml \
  -o ~/.claude/skills/utilities/evals/use-cases/<name>/rubric.md
```
