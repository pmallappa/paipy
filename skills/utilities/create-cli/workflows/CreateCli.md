...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Running the CreateCli workflow in the create-cli skill to generate new CLI"}' \
  > /dev/null 2>&1 &
```

Running the **CreateCli** workflow in the **create-cli** skill to generate new CLI...
