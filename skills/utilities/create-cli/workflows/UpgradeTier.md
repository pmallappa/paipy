...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Running the UpgradeTier workflow in the create-cli skill to upgrade CLI tier"}' \
  > /dev/null 2>&1 &
```

Running the **UpgradeTier** workflow in the **create-cli** skill to upgrade CLI tier...
