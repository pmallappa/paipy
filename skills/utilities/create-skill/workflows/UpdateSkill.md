...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Running the UpdateSkill workflow in the create-skill skill to modify existing skill"}' \
  > /dev/null 2>&1 &
```

Running the **UpdateSkill** workflow in the **create-skill** skill to modify existing skill...
