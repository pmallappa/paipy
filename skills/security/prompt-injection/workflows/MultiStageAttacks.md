...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Running the MultiStageAttacks workflow in the prompt-injection skill to test attack chains"}' \
  > /dev/null 2>&1 &
```

Running the **MultiStageAttacks** workflow in the **prompt-injection** skill to test attack chains...
