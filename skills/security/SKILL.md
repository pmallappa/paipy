...
| Web assessment, OWASP, pentest, ffuf, app security, threat modeling | `web-assessment/SKILL.md` |
| Prompt injection, jailbreak, LLM security, guardrail bypass | `prompt-injection/SKILL.md` |
| Security news, sec updates, breaches, tldrsec, security research | `sec-updates/SKILL.md` |
| Annual reports, security trends, threat landscape, vendor reports | `annual-reports/SKILL.md` |
