...
**Location:** `osint-tools/Osintgram/`
...
**Location:** `osint-tools/tinfoleak/`
...
- Command: `source osint-tools/osint-venv/bin/activate`
...
## 📋 Integration with web-assessment Skill
