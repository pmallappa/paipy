...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Running the TechnicalCreativityGemini3 workflow in the be-creative skill to generate technical solutions"}' \
  > /dev/null 2>&1 &
```

Running **TechnicalCreativityGemini3** in **be-creative**...
...
1. Load workflow: `read ~/.claude/skills/be-creative/workflows/TechnicalCreativityGemini3.md`
