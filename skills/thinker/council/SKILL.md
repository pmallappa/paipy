---
name: council
description: Multi-agent debate with visible transcripts where agents respond to each other. USE WHEN council, debate, perspectives, weigh options, deliberate, multiple viewpoints. Unlike red-team (adversarial), Council is collaborative-adversarial.
---
...
**Key Differentiator from red-team:** Council is collaborative-adversarial (debate to find best path), while red-team is purely adversarial (attack the idea). Council produces visible conversation transcripts; red-team produces steelman + counter-argument.
