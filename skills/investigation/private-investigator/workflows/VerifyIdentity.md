...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Running the VerifyIdentity workflow in the private-investigator skill to confirm identity"}' \
  > /dev/null 2>&1 &
```

Running the **VerifyIdentity** workflow in the **private-investigator** skill to confirm identity...
