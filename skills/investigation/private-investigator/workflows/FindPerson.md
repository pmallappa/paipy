...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Running the FindPerson workflow in the private-investigator skill to locate individuals"}' \
  > /dev/null 2>&1 &
```

Running the **FindPerson** workflow in the **private-investigator** skill to locate individuals...
