...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Running the SocialMediaSearch workflow in the private-investigator skill to find profiles"}' \
  > /dev/null 2>&1 &
```

Running the **SocialMediaSearch** workflow in the **private-investigator** skill to find profiles...
