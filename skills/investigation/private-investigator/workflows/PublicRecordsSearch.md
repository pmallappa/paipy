...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Running the PublicRecordsSearch workflow in the private-investigator skill to search records"}' \
  > /dev/null 2>&1 &
```

Running the **PublicRecordsSearch** workflow in the **private-investigator** skill to search records...
