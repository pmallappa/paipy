...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Running the ReverseLookup workflow in the private-investigator skill to trace identifiers"}' \
  > /dev/null 2>&1 &
```

Running the **ReverseLookup** workflow in the **private-investigator** skill to trace identifiers...
